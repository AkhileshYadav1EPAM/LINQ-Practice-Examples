...
{
    public class SingleOrDefault : EmployeeData
    {
        public void SingleOrDefaultMethod()
        {
            ...
            var employeeWithAge17 = employeeList.SingleOrDefault(emp => emp.Age == 17);
            ...
            try
            {
                var employeeWithDepartmentIdAs102 = employeeList.SingleOrDefault(emp => emp.DepartmentId == 102);
